...
# Semente fixa para reprodutibilidade dos resultados reportados em resultados_aula07.md
np.random.seed(42)
...
for t in range(max_iter):
    for i in range(num_particles):
        ...
        # Equação de atualização da velocidade da partícula i
...
print(f"[LAB 03] Fitness da melhor posição (gbest): {fitness_function(gbest_X)}")
